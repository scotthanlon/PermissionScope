...
@objc public class PermissionScope: UIViewController, CLLocationManagerDelegate, UIGestureRecognizerDelegate, CBPeripheralManagerDelegate {
    ...
    public var closeButton                  = UIButton(frame: CGRect(x: 0, y: 0, width: 60, height: 32))
    ...
    public init(backgroundTapCancels: Bool) {
        ...
        // close button
        closeButton.setTitle("Cancel".localized, forState: .Normal)
    ...
    public override func viewWillLayoutSubviews() {
        ...
        for button in permissionButtons {
            ...
            button.frame.offsetInPlace(dx: 0, dy: -((dialogHeight/2)-110) + CGFloat(index * baseOffset))
            ...
            statusForPermission(type,
                                completion: { currentStatus in
                                    ...
                                    if currentStatus == .Authorized {
                                        ...
                                        button.setTitle("ALLOW ACCESS TO \(prettyDescription)".localized.uppercaseString, forState: .Normal)
                                        ...
                                        button.setTitle("ALLOW ACCESS TO \(prettyDescription)".localized.uppercaseString, forState: .Normal)
                                        button.backgroundColor = UIColor(red: 237/255, green: 185/255, blue: 31/255, alpha: 1)
                                    ...
                                    label.frame.offsetInPlace(dx: 0, dy: -((dialogHeight/2)-155) + CGFloat(index * baseOffset))
